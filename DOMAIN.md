...
В основе домена лежат шесть ключевых сущностей, которые формируют модель клавиатуры и процесса обучения:
...
- **Понятия:** `Stream`, `Lesson`, `Exercise`, `TrainingSession`, `Speed`, `Accuracy`.
...
- **`FlowLine` (Строка потока):** Ключевой компонент упражнения, представляющий собой интерактивную строку для ввода текста. Визуально имитирует движение каретки печатной машинки. Состоит из трех частей:
