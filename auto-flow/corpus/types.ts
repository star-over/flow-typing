...
export interface DrillRecord {
  ...
  bigrams: string[];
  /**
   * Частотность символов — плотность для фокус-ранжирования. Массивом, а не
   * объектом: ключи-символы кириллические, а Convex запрещает не-ASCII в именах
   * полей. Символ здесь — значение, не имя поля.
   */
  symbolFrequency: SymbolCount[];
}

/** Частотность одного символа. */
