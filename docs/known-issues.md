...
## 1. `defaultDrillTexts` не учитывает выбранную раскладку

**Дата фиксации:** 2026-06-05
**Когда решать:** при подключении БД (drills получат собственный `symbolLayoutId`, fallback станет не нужен)
