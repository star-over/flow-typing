...
**Решение:** горизонтальная плашка-сегментатор из 5 кнопок: «1 min», «3 min», «5 min», «10 min», «15 min».

**Отвергнуто:**
- Обычный `<Select>` в списке настроек — для быстрого частого выбора (один клик вместо двух) и визуального обзора всех вариантов сегментатор удобнее.
