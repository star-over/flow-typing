 ...
 * финальный CTA). Бренд-акцент CTA — фирменный янтарь, роль темы
 * `--color-brand-accent` (эталон — sepia; после ADR 0028 янтарь — акцент бренда,
 * а не цель), тот же, что красит каретку «T» в Wordmark. Спектр пальцев играет
