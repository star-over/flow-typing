 ...
 *   красятся след, кольцо тапа, гало и ободок точки. Тема выбирает язык: спектр пальца
 *   (light/dark/nord) ИЛИ единый цвет маршрута — модель «навигатор», ADR 0026 (в sepia
 *   все 10 = маршрут, движение отклеено от пальца).
 ...
 *   нейтральная бусина (бронза на светлых / жемчужина на тёмных) ИЛИ голова маршрута
 *   (индиго — sepia, навигатор). Контрастно фону; идентичность пальца движение не несёт.
 */
