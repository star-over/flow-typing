...
<style>
  ...
  .keycap.role-target {
    ...
    /* Цель — заливка, не кольцо (ADR 0028). Гасим внутренний ободок: когда клавиша-
       цель совпала с домашней (путь из одной клавиши), `.keycap.home` повесил бы
       тёмный home-ободок (`--color-keycap-label`) поверх плотной заливки — он читался
       бы чёрной рамкой. Правило (0,2,0) объявлено ниже `.keycap.home` (тоже 0,2,0) и
       перебивает его `--kc-inner-ring`; на не-домашней цели ободок и так прозрачный. */
    --kc-inner-ring: 0 0 0 0 transparent;
    font-weight: 900;
  }
